-- سكربت واحد لعمل Duplicate لأي Tool ممسوك مع GUI قابل للسحب
...
-- إنشاء RemoteEvent في حال ما كان موجود
local REMOTE_NAME = "RequestDuplicateTool"
...
-- إذا السكربت شغال في السيرفر (عبر RunService) نعمل وظيفة النسخ
if RunService:IsServer() then
	...
	return -- نوقف تنفيذ باقي الكود على السيرفر
end

-- ========= إنشاء الـGUI =========
local screenGui = Instance.new("ScreenGui")
screenGui.Name = "DuplicateToolGUI"
